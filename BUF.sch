...
N 280 -80 280 -30 {lab=#net1}
N 280 -30 280 20 {lab=#net1}
N 320 -50 320 -30 {lab=OUT}
N 320 -30 460 -30 {lab=OUT}
N 320 -30 320 -10 {lab=OUT}
N 320 -80 330 -80 {lab=VDD}
N 330 -120 330 -80 {lab=VDD}
N 320 -120 330 -120 {lab=VDD}
N 320 20 330 20 {lab=GND}
N 330 20 330 60 {lab=GND}
N 320 60 330 60 {lab=GND}
N -0 -30 280 -30 {lab=#net1}
...
C {symbols/pfet_03v3.sym} 300 -80 0 0 {name=M3
L=0.28u
W=1u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 300 20 0 0 {name=M4
L=0.28u
W=0.5u
nf=1
m=1
...
C {opin.sym} 460 -30 0 0 {name=p4 lab=OUT}
C {vdd.sym} 320 -140 0 0 {name=l3 lab=VDD}
C {gnd.sym} 320 80 0 0 {name=l4 lab=GND}
