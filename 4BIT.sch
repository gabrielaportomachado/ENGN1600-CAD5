...
N -80 390 -50 390 {lab=OUT2}
N 170 390 200 390 {lab=OUT2}
N -190 390 -140 390 {lab=IN2}
N 70 390 110 390 {lab=Ax-2}
N -110 390 -110 470 {lab=GND}
N 140 390 140 470 {lab=GND}
N -110 270 -110 350 {lab=Sh}
N 140 270 140 350 {lab=Shb}
N -80 630 -50 630 {lab=OUT3}
N 170 630 200 630 {lab=OUT3}
N -190 630 -140 630 {lab=IN3}
N 70 630 110 630 {lab=Ax-3}
N -110 630 -110 710 {lab=GND}
N 140 630 140 710 {lab=GND}
N -110 510 -110 590 {lab=Sh}
N 140 510 140 590 {lab=Shb}
N 320 30 360 30 {lab=OUT2}
N 320 80 360 80 {lab=OUT1}
...
C {symbols/nfet_03v3.sym} -110 370 1 0 {name=M5
L=0.28u
W=0.5u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 140 370 1 0 {name=M6
L=0.28u
W=0.5u
nf=1
m=1
...
C {lab_wire.sym} -50 390 0 0 {name=p21 sig_type=std_logic lab=OUT2}
C {lab_wire.sym} 200 390 0 0 {name=p22 sig_type=std_logic lab=OUT2}
C {ipin.sym} 70 390 0 0 {name=p23 lab=Ax-2}
C {lab_wire.sym} -110 460 1 0 {name=p24 sig_type=std_logic lab=GND}
C {lab_wire.sym} 140 460 1 0 {name=p25 sig_type=std_logic lab=GND}
C {ipin.sym} -190 390 0 0 {name=p26 lab=IN2}
C {lab_wire.sym} -110 340 1 0 {name=p27 sig_type=std_logic lab=Sh}
C {lab_wire.sym} 140 340 1 0 {name=p28 sig_type=std_logic lab=Shb}
C {symbols/nfet_03v3.sym} -110 610 1 0 {name=M7
L=0.28u
W=0.5u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 140 610 1 0 {name=M8
L=0.28u
W=0.5u
nf=1
m=1
...
C {lab_wire.sym} -50 630 0 0 {name=p29 sig_type=std_logic lab=OUT3}
C {lab_wire.sym} 200 630 0 0 {name=p30 sig_type=std_logic lab=OUT3}
C {ipin.sym} 70 630 0 0 {name=p31 lab=Ax-3}
C {lab_wire.sym} -110 700 1 0 {name=p32 sig_type=std_logic lab=GND}
C {lab_wire.sym} 140 700 1 0 {name=p33 sig_type=std_logic lab=GND}
C {ipin.sym} -190 630 0 0 {name=p34 lab=IN3}
C {lab_wire.sym} -110 580 1 0 {name=p35 sig_type=std_logic lab=Sh}
C {lab_wire.sym} 140 580 1 0 {name=p36 sig_type=std_logic lab=Shb}
C {opin.sym} 360 30 0 0 {name=p37 lab=OUT2}
C {opin.sym} 360 80 0 0 {name=p38 lab=OUT3}
